...
export default function ProductDetailModal({ product, onClose, onChangeSelectedQty, onAddToCart }) {
                        ...
                        <div className="detail-content">
                            ...
                            <div className="detail-actions">
                                ...
                                <div className="btn-group">
                                    {product.ar && (
                                        <button className="btn-main btn-outline" id="btnAR" onClick={() => { /* placeholder untuk AR action */ }}>
                                    ...
                                    <button className="btn-main btn-primary" onClick={() => onAddToCart && onAddToCart()}>
                                        Tambah ke Keranjang
                                    </button>
                                </div>
                            </div>
